...
const ProductTable = () => {
    ...
    useEffect(() => {
        ...
        //Llamamos a la funcion para obener todos los productos declarados en el ProductService
    ...
    //Test, este log está modificado para que muestre los datos de una forma mas legible
